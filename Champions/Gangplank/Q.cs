...
namespace Spells
{
    public class Parley : GameScript
    {
        ...
        {
            var isCrit = new Random().Next(0, 100) < owner.Stats.CriticalChance;
            var baseDamage = new[] {20, 45, 70, 95, 120}[spell.Level - 1] + owner.Stats.TotalAttackDamage;
            var damage = isCrit ? baseDamage * owner.Stats.TotalCriticalDamage / 100 : baseDamage;
            ...
            if (target != null && !target.IsDead)
            {
                ...
                if (target.IsDead)
                {
                    ...
                    var newMana = owner.Stats.CurrentPar + manaCost / 2;
